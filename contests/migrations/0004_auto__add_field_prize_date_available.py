...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'contests_prize', 'date_available',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 7, 2, 0, 0), blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'contests.prize': {
            ...
            'contest': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contests.Contest']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_available': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
