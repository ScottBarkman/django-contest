...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Code.contest'
        db.add_column(u'contests_code', 'contest',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['contests.Contest']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Code.contest'
        db.delete_column(u'contests_code', 'contest_id')
