...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Entry'
        db.create_table(u'contests_entry', (
            ...
            ('prize', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contests.Prize'], null=True, on_delete=models.SET_NULL, blank=True)),
        ))
        db.send_create_signal(u'contests', ['Entry'])

        # Adding field 'Prize.date_available'
        db.add_column(u'contests_prize', 'date_available',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Prize.number_available'
        db.add_column(u'contests_prize', 'number_available',
                      self.gf('django.db.models.fields.IntegerField')(default=1, blank=True),
                      keep_default=False)

        # Adding field 'Contest.instant_win_odds'
        db.add_column(u'contests_contest', 'instant_win_odds',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Contest.daily'
        db.add_column(u'contests_contest', 'daily',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'contests_entry')

        # Deleting field 'Prize.date_available'
        db.delete_column(u'contests_prize', 'date_available')

        # Deleting field 'Prize.number_available'
        db.delete_column(u'contests_prize', 'number_available')

        # Deleting field 'Contest.instant_win_odds'
        db.delete_column(u'contests_contest', 'instant_win_odds')

        # Deleting field 'Contest.daily'
        db.delete_column(u'contests_contest', 'daily')
    ...
    models = {
        ...
        u'contests.prize': {
            ...
            'contest': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contests.Contest']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_available': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
